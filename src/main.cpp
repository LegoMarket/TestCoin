...
uint256 hashGenesisBlock("0xf2303fe530f2ce96ef5082d070d0b69088bcfb3264457ab916d0466672edd1c2");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Legocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Legocoin Signed Message:\n";
...
{
    // Legocoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Legocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Legocoin: 3.5 days
static const int64 nTargetSpacing = 150; // Legocoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Legocoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Legocoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Legocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcce2670d4221d257b8a44472cd92acf09e4d85cf95919bf1e00dbd1259684231");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("49274febf6f7e10dfcbaadde60d2ee1efbc6755eedf146dac6fe2ef1fc03fab6612e1b4829fa261271cce48fc9d62b4647fc8a3e6ada10d981a540b8256ea56edc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1526232515;
        block.nBits    = 504365644;
        block.nNonce   = 2441937681;

        if (fTestNet)
        {
            block.nTime    = 1526232515;
            block.nNonce   = 1815857446;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8f4459897bf7d6a69e090ea86549d105e26c74239174ce38f03b3d9a8e5774dc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Legocoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LegocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LegocoinMiner : ProcessBlock, block not accepted");
    }
